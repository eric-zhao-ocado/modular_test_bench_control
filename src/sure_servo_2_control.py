...
class EnipServer:
    ...
    def send_command(
        ...
        with client.connector(host=self.ip_addr) as conn:
            for _index, _descr, _op, _reply, _status, value in conn.synchronous(
...
class Sv2Servo(EnipServer):
    ...
    def exit_handler(self, decel=1):
        ...
        exit_path = Sv2ConstSpeed(self, 1, 0, decel)
...
class Sv2ConstSpeed(Sv2MovementPath):
    ...
    """
    def __init__(self, servo, path_num, speed=0, acc=0, ins=1, auto=0, unit=0):
        """
